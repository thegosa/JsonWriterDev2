...
public class add_unplash_wallpapers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                        theme.put("image", "https://source.unsplash.com/" + all_text.getText() +"/2780x2780");
                        all_text.setText("");
                ...
                try {
                    save(add_unplash_wallpapers.this, jsonStr);
                } catch (IOException e) {
                    e.printStackTrace();
                }
                /*
    ...
    public JSONObject makJsonObject(int id[], String name[], String year[],
        ...
        save(add_unplash_wallpapers.this, String.valueOf(jsonArray));
        return obj;
